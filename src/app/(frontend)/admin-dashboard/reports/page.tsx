...
import { Search, Download, Calendar, Filter, Users, UserCheck, FileText, Home, BarChart3, Clock, UserPlus, Edit, CheckCircle, AlertCircle, Plus, Trash2 } from 'lucide-react'
...
function getActivityBadge(type: string) {
  ...
  const badge = badges[type as keyof typeof badges] || { label: "System", color: "bg-gray-100 text-gray-800" }
...
export default function ReportsPage() {
  ...
  const handleDownloadReport = () => {
    ...
    console.log("Downloading report with filters:", { searchTerm, actorFilter, typeFilter, dateRange })
      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center justify-between border-b px-6">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold">Reports & Activity Logs</h1>
          </div>
              ...
              <div className="space-y-4">
                {filteredLogs.length === 0 ? (
                  ...
                  filteredLogs.map((log, index) => (
                    <Card key={log.id} className="shadow-sm border-l-4 border-l-blue-200 hover:shadow-md transition-shadow">
